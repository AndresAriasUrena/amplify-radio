                    ...
                    <div className="mb-8 md:mb-0 max-w-xs mx-auto lg:mx-0 text-center lg:text-left flex flex-col items-center lg:items-start">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li><Link href="/about-us" className="hover:text-[#E5754C] transition-colors">Sobre Nosotros</Link></li>
                       ...
                       <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li><Link href="/news?categories=actualidad" className="hover:text-[#E5754C] transition-colors">Actualidad</Link></li>
                                <li><Link href="/news?categories=tendencia" className="hover:text-[#E5754C] transition-colors">Tendencia</Link></li>
                                <li><Link href="/news?categories=entretenimiento" className="hover:text-[#E5754C] transition-colors">Entretenimiento</Link></li>
                                <li><Link href="/news?categories=negocios" className="hover:text-[#E5754C] transition-colors">Negocios</Link></li>
                                <li><Link href="/news?categories=uncategorized" className="hover:text-[#E5754C] transition-colors">Sin categoría</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li><a href="https://www.instagram.com/amplifyradiofm/" target="_blank" rel="noopener noreferrer" className="hover:text-[#E5754C] transition-colors">Instagram</a></li>
                                <li><a href="https://www.facebook.com/amplifyradiofm/" target="_blank" rel="noopener noreferrer" className="hover:text-[#E5754C] transition-colors">Facebook</a></li>
                                <li><a href="https://x.com/amplifyradiofm" target="_blank" rel="noopener noreferrer" className="hover:text-[#E5754C] transition-colors">Twitter (X)</a></li>
                            </ul>
                        </div>
            ...
            <div className="w-full bg-[#E5754C] py-4">
                <div className="container mx-auto max-w-7xl px-4 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex gap-4">
                        <a href="https://www.facebook.com/amplifyradiofm/" target="_blank" rel="noopener noreferrer" className="text-black hover:opacity-80 transition-opacity">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/amplifyradiofm/" target="_blank" rel="noopener noreferrer" className="text-black hover:opacity-80 transition-opacity">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://x.com/amplifyradiofm" target="_blank" rel="noopener noreferrer" className="text-black hover:opacity-80 transition-opacity">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
